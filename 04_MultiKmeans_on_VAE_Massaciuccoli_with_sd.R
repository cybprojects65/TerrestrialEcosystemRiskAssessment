################################################################################
#####            Multi k-Means on Varational Autoencoder Index             #####
################################################################################
...
# File to select
variables_risk1_standardized <- read.csv(file="./output/VAE_varational_auto_encoder/out_2024_pr_n10_test/selection_high_risk_anomalies_0p_50p_10_hidden_nodes.csv", header=TRUE, sep=",")
...
########################################################################  
  ...
  write.csv(centroidi_annotated, 
            file = paste0("./output/MultiKmeans_on_VAE/seq_from05_to30_by1_n1000_sd_1&2_quartile/centroidi_annotated_", n_centroidi, "_", year, ".csv"), 
            row.names = FALSE)
  ...
  output_file<-paste0("./output/MultiKmeans_on_VAE/seq_from05_to30_by1_n1000_sd_1&2_quartile/centroid_classification_assignment_",n_centroidi,"_", year, ".csv")
